...
CREATE INDEX IF NOT EXISTS api_data_rights_owner_idx ON api_data_rights_operations(tenant_id, user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS api_data_rights_retention_idx ON api_data_rights_operations(status, retention_until);
...
REVERSE_SQL = "DROP TABLE IF EXISTS api_data_rights_operations;"
...
class Migration(migrations.Migration):
    dependencies = [('api_schema', '0002_identity_admin_tables')]
