...
- **Traefik v3**: Static config at `traefik/traefik.yml` and dynamic routers at `traefik/traefik-config/dynamic.yml`. Uses Let's Encrypt staging resolver `le-staging`.
