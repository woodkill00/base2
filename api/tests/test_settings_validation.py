...
@pytest.mark.parametrize(
    ...
    (
        ...
        'postgresql://owner:secret@localhost.:5432/app',
        'postgresql://owner:secret@localhost.localdomain:5432/app',
        'postgresql://owner:secret@service.localhost:5432/app',
        'postgresql://owner:secret@localhost6:5432/app',
        'postgresql://owner:secret@localhost6.localdomain6:5432/app',
        'postgresql://owner:secret@ip6-localhost:5432/app',
        'postgresql://owner:secret@ip6-loopback:5432/app',
        ...
        'postgresql://owner:secret@2130706433:5432/app',
        'postgresql://owner:secret@127.1:5432/app',
        'postgresql://owner:secret@017700000001:5432/app',
        'postgresql://owner:secret@0x7f000001:5432/app',
