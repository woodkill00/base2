...
const COPY = {
  ...
  de: {
    ...
    terms: {
      ...
      'public.root': 'Öffentliche Startseite',
      'database.ready': 'Datenbank bereit',
      'workers.ready': 'Worker bereit',
      'queues.delay': 'Warteschlangenverzögerung',
      'objects.ready': 'Objektspeicher bereit',
      'dns.canonical': 'Kanonisches DNS',
      'certificate.expiry': 'Zertifikatsablauf',
      'email.delivery': 'E-Mail-Zustellung',
      'schedules.freshness': 'Zeitplanaktualität',
      'capacity.headroom': 'Kapazitätsreserve',
      'monitoring.self': 'Selbstüberwachung',
      'database.performance': 'Datenbankleistung',
      'backup.freshness': 'Sicherungsaktualität',
      'restore.last-drill': 'Letzte Wiederherstellungsübung',
      'migrations.state': 'Migrationsstatus',
  ...
  ar: {
    ...
    terms: {
      ...
      'public.root': 'الصفحة الرئيسية العامة',
      'database.ready': 'قاعدة البيانات جاهزة',
      'workers.ready': 'العاملون جاهزون',
      'queues.delay': 'تأخير قائمة الانتظار',
      'objects.ready': 'تخزين الكائنات جاهز',
      'dns.canonical': 'نظام أسماء النطاقات الأساسي',
      'certificate.expiry': 'انتهاء صلاحية الشهادة',
      'email.delivery': 'تسليم البريد الإلكتروني',
      'schedules.freshness': 'حداثة الجداول',
      'capacity.headroom': 'هامش السعة',
      'monitoring.self': 'المراقبة الذاتية',
      'database.performance': 'أداء قاعدة البيانات',
      'backup.freshness': 'حداثة النسخة الاحتياطية',
      'restore.last-drill': 'آخر اختبار استعادة',
      'migrations.state': 'حالة الترحيلات',
