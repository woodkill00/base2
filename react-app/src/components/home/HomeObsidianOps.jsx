    ...
    >
      ...
      <div className="home-obsidian-section-head">
        <div>
          ...
          <p>
            The reference command palette, boot sequence, and utility rail are translated into Base2
            controls, with live app workflows named directly instead of fictional system copy.
          </p>
        </div>
      ...
      <div className="home-ops-grid">
        <div data-testid="base2-boot-sequence-panel">
          <GlassCard className="home-boot-panel">
        ...
        <div data-testid="base2-command-palette-preview">
          <GlassCard className="home-command-palette-preview">
        ...
        <div data-testid="base2-utility-rail-preview">
          <GlassCard className="home-utility-rail-preview">
