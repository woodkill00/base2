    ...
    <div className="base2-section-shell" tabIndex={0}>
      <div className="base2-integrated-copy">
        ...
        <p>
          ...
          staging-first deploys, and readable operational proof. The visual shell should feel like
          the same volcanic command center from the hero all the way through the final handoff.
        </p>
      </div>
