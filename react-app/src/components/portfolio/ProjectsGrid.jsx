...
const modules = [
  {
    ...
    detail:
      'Agents work against isolated feature branches with push approval and review summaries.',
  ...
  },
  {
    ...
    detail:
      'Disposable DigitalOcean staging targets can be created, tested, updated, and destroyed.',
  ...
  },
  {
    ...
    title: 'Visual proof',
    detail:
      'Desktop, tablet, and phone captures are compared against the requested design behavior.',
  ...
  },
  {
    ...
    detail:
      'Docker install, unit tests, build, smoke, and live readiness results stay tied to the run.',
...
const ProjectsGrid = () => (
  <section
    id="projects"
    className="base2-integrated-section base2-viewport-section base2-integrated-projects"
